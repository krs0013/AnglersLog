...
public class FishingRegulatoryPagerActivity extends ActionBarActivity {
...
//        });
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    currentFrag = SouthCarolinaFishRegFragment.newInstance(0, "South Carolina", scUrl);
                    return currentFrag;
                case 1:
                    currentFrag = SouthCarolinaFishRegFragment.newInstance(0, "Georgia", gaUrl);
                    return currentFrag;
                case 2:
                    currentFrag = SouthCarolinaFishRegFragment.newInstance(1, "Florida", flUrl);
                    return currentFrag;
                case 3:
                    currentFrag = SouthCarolinaFishRegFragment.newInstance(1, "Alabama", alUrl);
                    return currentFrag;
                case 4:
                    currentFrag = SouthCarolinaFishRegFragment.newInstance(1, "Mississippi", msUrl);
                    return currentFrag;
                default:
                    return null;
            }
